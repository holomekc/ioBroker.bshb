...
class BshbUserDefinedStatesHandler extends bshb_handler_1.BshbHandler {
    ...
    handleBshcUpdate(resultEntry) {
        if (resultEntry['@type'] === 'userDefinedState') {
            ...
            (0, rxjs_1.from)(this.bshb.setStateAsync(id, { val: resultEntry['state'], ack: true }))
    ...
    detectUserDefinedStates() {
        ...
        }).pipe((0, rxjs_1.switchMap)(() => this.getBshcClient().getUserDefinedStates(undefined, { timeout: this.long_timeout })), (0, rxjs_1.switchMap)(response => this.deleteMissingUserDefinedStates((response.parsedResponse)).pipe((0, rxjs_1.last)(undefined, void 0), (0, rxjs_1.switchMap)(() => (0, rxjs_1.from)(response.parsedResponse)))), (0, rxjs_1.mergeMap)(userDefinedState => {
    ...
    deleteMissingUserDefinedStates(userDefinedStates) {
        return (0, rxjs_1.from)(this.bshb.getStatesOfAsync('userDefinedStates', '')).pipe((0, rxjs_1.switchMap)(objects => (0, rxjs_1.from)(objects)), (0, rxjs_1.switchMap)(object => {
            ...
            if (!found) {
                return (0, rxjs_1.from)(this.bshb.deleteStateAsync('userDefinedStates', '', object.native.id)).pipe((0, rxjs_1.tap)(() => this.bshb.log.info(`User defined state with id=${object.native.id} removed because it does not exist anymore.`)), (0, operators_1.catchError)(err => {
