...
class BshbBackupHandler extends bshb_handler_1.BshbHandler {
            ...
            if (state.val) {
                if (id.endsWith('createBackup')) {
                    result = this.createBackup()
                        .pipe((0, rxjs_1.switchMap)(() => this.waitForReadyState()), (0, rxjs_1.switchMap)(() => this.getBackup()), (0, rxjs_1.switchMap)(response => this.storeBackupFile(response)), (0, rxjs_1.switchMap)(() => this.deleteBackupFromController()), (0, rxjs_1.switchMap)(() => {
                    ...
                    result = this.getBshcClient().deleteBackup({ timeout: this.long_timeout })
    ...
    createBackup() {
        ...
        return this.getBshcClient().createBackup(this.bshb.config.systemPassword, undefined, { timeout: this.long_timeout });
    }
    waitForReadyState() {
        this.bshb.log.debug('[Backup] Backup creation triggered. Waiting for READY state');
        return this.backupStatus$
            .pipe((0, rxjs_1.filter)(status => status === 'READY'), (0, rxjs_1.take)(1));
    }
    getBackup() {
    ...
    detectBackup() {
        return this.createBackupFolder()
            .pipe((0, rxjs_1.switchMap)(() => this.createBackupStatusFolder()), (0, rxjs_1.switchMap)(() => this.getBshcClient().getBackupStatus({ timeout: this.long_timeout })
            .pipe((0, rxjs_1.mergeMap)(response => (0, rxjs_1.from)(Object.entries(response.parsedResponse))), (0, rxjs_1.filter)(([key, _]) => key !== '@type'), (0, rxjs_1.mergeMap)(([key, value]) => this.addState('backup.backupStatus', 'BackupStatus', key, value)))), (0, rxjs_1.switchMap)(() => this.createRestoreStatusFolder()), (0, rxjs_1.switchMap)(() => this.getBshcClient().getRestoreStatus({ timeout: this.long_timeout })
