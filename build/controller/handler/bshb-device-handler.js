...
class BshbDeviceHandler extends bshb_handler_1.BshbHandler {
    ...
    sendUpdateToBshc(id, state) {
        ...
        if (cachedState &&
            utils_1.Utils.isLevelActive(this.bshb.log.level, log_level_1.LogLevel.debug)) {
    ...
    restoreCache() {
        const start = (0, rxjs_1.of)("").pipe((0, operators_1.tap)(() => this.bshb.log.info("Restoring cache started...")));
        ...
        (0, rxjs_1.mergeMap)((obj) => (0, rxjs_1.from)(this.bshb.getChannelsOfAsync(obj.native.device.id))), (0, operators_1.switchMap)((result) => (0, rxjs_1.from)(result)), (0, rxjs_1.filter)((obj) => obj.native.device &&
        ...
        const states = deviceServices.pipe((0, rxjs_1.mergeMap)((obj) => (0, rxjs_1.from)(this.bshb.getStatesOfAsync(obj.native.device.id, obj.native.deviceService.id))), (0, operators_1.switchMap)((result) => (0, rxjs_1.from)(result)), (0, rxjs_1.filter)((obj) => obj.native.device &&
            obj.native.device.id &&
            obj.native.deviceService &&
            obj.native.deviceService.id &&
    ...
    detectDevices() {
        const rooms = this.getBshcClient()
            ...
            .pipe((0, operators_1.tap)(() => this.bshb.log.info("Start detecting devices...")), (0, operators_1.switchMap)((response) => {
        ...
        const devices = this.getBshcClient()
            ...
            .pipe((0, operators_1.switchMap)((response) => (0, rxjs_1.from)(response.parsedResponse)), (0, rxjs_1.mergeMap)((device) => {
    ...
    checkDeviceServices() {
        return this.getBshcClient()
            ...
            return (0, rxjs_1.from)(this.bshb.getObjectAsync(deviceService.deviceId)).pipe((0, operators_1.switchMap)((ioBrokerDevice) => {
                if (!ioBrokerDevice) {
                    this.bshb.log.error("Found device but value is undefined. This should not happen: deviceId=" +
    ...
    importSimpleState(idPrefix, device, deviceService, stateKey, stateValue, write) {
        ...
        const deviceType = deviceService && deviceService.state
        ...
        return this.setObjectNotExistsAsync(id, {
            ...
            common: {
                ...
                role: role,
                read: true,
                write: typeof write === "undefined"
                    ? bshb_definition_1.BshbDefinition.determineWrite(deviceType, stateKey)
                    : write,
                unit: unit,
                states: states,
            },
